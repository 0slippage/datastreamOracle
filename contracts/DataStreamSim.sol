...
//. 0.2.4 Instructions specified this line (https://github.com/smartcontractkit/chainlink-local/releases/tag/v0.2.4):
//
import {DataStreamsLocalSimulator} from "@chainlink/local/src/data-streams/DataStreamsLocalSimulator.sol";

//. 0.2.5 Instructions specified this line (https://github.com/smartcontractkit/chainlink-local/releases/tag/v0.2.5):
//
